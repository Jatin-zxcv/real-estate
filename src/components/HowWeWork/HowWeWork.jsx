      ...
      <div className="how-we-work-col how-we-work-header" ref={headerRef}>
        <div className="container">
          <div className="how-we-work-header-content">
            ...
            <Copy delay={0.15}>
              <h3>
                From first consultation to final handover, our process ensures 
                you find the perfect property with confidence
              </h3>
            </Copy>
      ...
      <div className="how-we-work-col how-we-work-cards" ref={cardsRef}>
        <div className="how-we-work-card">
          <div className="how-we-work-card-img">
            <img src="/how-we-work/process-1.jpg" alt="Consultation" />
          </div>
          <div className="how-we-work-card-copy">
            ...
            <p className="md">
              We start by understanding your needs — budget, preferred locations, 
              property type, and timeline. This helps us curate properties that 
        ...
        <div className="how-we-work-card">
          <div className="how-we-work-card-img">
            <img src="/how-we-work/process-2.jpg" alt="Property Selection" />
          </div>
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
            ...
            <p className="md">
              Based on your criteria, we present handpicked properties with 
              verified details. Each listing includes pricing transparency, 
              legal status, and neighborhood insights.
            </p>
          </div>
        </div>
        <div className="how-we-work-card">
          <div className="how-we-work-card-img">
            <img src="/how-we-work/process-3.jpg" alt="Site Visits" />
          </div>
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>Site Visits & Verification</h3>
            </div>
            <p className="md">
              We arrange convenient site visits and guide you through each 
              property. Our team verifies documentation, ownership, and legal 
        ...
        <div className="how-we-work-card">
          <div className="how-we-work-card-img">
            <img src="/how-we-work/process-4.jpg" alt="Deal Closure" />
          </div>
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>Deal Closure</h3>
            ...
            <p className="md">
              Once you've chosen your property, we assist with negotiations, 
              documentation, and registration. Our support continues until 
